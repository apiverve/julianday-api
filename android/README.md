# Julian Day Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:julianday-api:1.1.14'
}
```
...
```java
import com.apiverve.julianday.JulianDayCalculatorAPIClient;
import com.apiverve.julianday.APIResponse;
import com.apiverve.julianday.APIException;

// Initialize the client
JulianDayCalculatorAPIClient client = new JulianDayCalculatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("date", "2024-03-15");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/julianday](https://docs.apiverve.com/ref/julianday)
...
- **Documentation:** [https://docs.apiverve.com/ref/julianday](https://docs.apiverve.com/ref/julianday)
- **Issues:** [GitHub Issues](https://github.com/apiverve/julianday-api/issues)
