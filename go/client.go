// Package julianday provides a Go client for the Julian Day Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/julianday?utm_source=go&utm_medium=readme
package julianday
...
const (
	baseURL        = "https://api.apiverve.com/v1/julianday"
	defaultTimeout = 30 * time.Second
)

// Client is the Julian Day Calculator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Julian Day Calculator API client.
...
// Execute makes a request to the Julian Day Calculator API with typed parameters.
//
...
//   - date (required): string - The Gregorian date in YYYY-MM-DD format [format: date]
