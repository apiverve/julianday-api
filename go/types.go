...
// Request contains the parameters for the Julian Day Calculator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Julian Day Calculator API.
type ResponseData struct {
	Gregorian string `json:"gregorian"`
	JulianDayNumber int `json:"julianDayNumber"`
	ModifiedJulianDate float64 `json:"modifiedJulianDate"`
