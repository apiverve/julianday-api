...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/julianday',
        'Source': 'https://github.com/apiverve/julianday-api',
        'Bug Tracker': 'https://github.com/apiverve/julianday-api/issues'
    },
    classifiers=[
