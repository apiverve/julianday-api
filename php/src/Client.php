...
/**
 * Client for the Julian Day Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/julianday?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/julianday';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\JuliandayClient] {$message}\n";
        }
    }
}
